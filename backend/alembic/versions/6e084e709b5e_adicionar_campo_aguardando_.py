...
def upgrade() -> None:
    ...
    op.drop_table('fornecedor_insumos_backup')
    ...
    op.drop_index(op.f('idx_log_preco_data'), table_name='log_mudancas_preco')
    op.drop_index(op.f('idx_log_preco_insumo'), table_name='log_mudancas_preco')
    op.drop_table('log_mudancas_preco')
    op.drop_table('insumos_backup')
    ...
    op.drop_index(op.f('idx_fornecedor_insumos_codigo'), table_name='fornecedor_insumos')
    op.drop_index(op.f('idx_fornecedor_insumos_fornecedor'), table_name='fornecedor_insumos')
    op.drop_index(op.f('idx_fornecedor_insumos_nome'), table_name='fornecedor_insumos')
    op.drop_constraint(op.f('uk_fornecedor_insumos_codigo'), 'fornecedor_insumos', type_='unique')
    op.create_index(op.f('ix_fornecedor_insumos_id'), 'fornecedor_insumos', ['id'], unique=False)
    op.drop_table_comment(
        'fornecedor_insumos',
        existing_comment='Catálogo de insumos oferecidos por cada fornecedor',
        schema=None
    )
    ...
    op.alter_column('fornecedores', 'estado',
               ...
               existing_nullable=True)
    op.drop_index(op.f('idx_fornecedores_cpf_cnpj'), table_name='fornecedores')
    op.drop_index(op.f('idx_fornecedores_estado'), table_name='fornecedores')
    op.drop_index(op.f('idx_fornecedores_nome'), table_name='fornecedores')
    op.drop_constraint(op.f('uk_fornecedores_cpf_cnpj'), 'fornecedores', type_='unique')
    ...
    op.add_column('insumos', sa.Column('aguardando_classificacao', sa.Boolean(), nullable=True, comment='TRUE = aguardando classificação pela IA, FALSE = não precisa ou já classificado'))
    ...
    op.alter_column('insumos', 'taxonomia_id',
               ...
               existing_nullable=True)
    op.drop_index(op.f('idx_insumos_anonimo'), table_name='insumos')
    op.drop_index(op.f('idx_insumos_fornecedor_id'), table_name='insumos')
    op.drop_index(op.f('idx_insumos_fornecedor_insumo'), table_name='insumos')
    op.drop_index(op.f('idx_insumos_subgrupo'), table_name='insumos')
    op.drop_index(op.f('idx_insumos_taxonomia_id'), table_name='insumos')
    op.create_index(op.f('ix_insumos_taxonomia_id'), 'insumos', ['taxonomia_id'], unique=False)
    op.drop_column('insumos', 'fornecedor_id')
    op.drop_column('insumos', 'valor_compra_por_kg')
    op.drop_column('insumos', 'total_comprado')
    ...
    op.alter_column('receita_insumos', 'observacoes',
               ...
               existing_nullable=True)
    op.drop_column('receita_insumos', 'ordem')
    ...
    op.alter_column('receitas', 'fator',
               ...
               type_=sa.Float(),
               existing_nullable=True)
    op.create_foreign_key(None, 'receitas', 'restaurantes', ['restaurante_id'], ['id'])
    op.alter_column('restaurantes', 'id',
               existing_type=sa.INTEGER(),
               comment='ID único do restaurante',
               existing_nullable=False,
               autoincrement=True)
    ...
    op.alter_column('restaurantes', 'ativo',
               existing_type=sa.BOOLEAN(),
               comment='Se o restaurante está ativo',
               existing_nullable=True)
    ...
    op.alter_column('taxonomias', 'ativo',
               ...
               existing_nullable=False)
    op.create_unique_constraint('uq_taxonomia_completa', 'taxonomias', ['categoria', 'subcategoria', 'especificacao', 'variante'])
