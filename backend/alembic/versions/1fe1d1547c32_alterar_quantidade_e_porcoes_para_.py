...
def upgrade() -> None:
    # Deletar índices da tabela taxonomia_aliases (se existirem)
    op.execute('DROP INDEX IF EXISTS ix_taxonomia_aliases_id')
    op.execute('DROP INDEX IF EXISTS ix_taxonomia_aliases_nome_alternativo')
    op.execute('DROP INDEX IF EXISTS ix_taxonomia_aliases_nome_normalizado')
    op.execute('DROP INDEX IF EXISTS ix_taxonomia_aliases_taxonomia_id')
    
    # Deletar tabela taxonomia_aliases (se existir)
    op.execute('DROP TABLE IF EXISTS taxonomia_aliases')
    ...
    """)
    op.execute('DROP INDEX IF EXISTS ix_receitas_codigo')
    op.execute('DROP INDEX IF EXISTS ix_receitas_grupo')
    op.execute('DROP INDEX IF EXISTS ix_receitas_subgrupo')
    op.create_unique_constraint(None, 'receitas', ['codigo'])
    op.execute('ALTER TABLE receitas DROP COLUMN IF EXISTS unidade')
    op.execute('ALTER TABLE receitas DROP COLUMN IF EXISTS preco_compra')
    op.execute('ALTER TABLE receitas DROP COLUMN IF EXISTS quantidade')
    op.execute('ALTER TABLE receitas DROP COLUMN IF EXISTS fator')
